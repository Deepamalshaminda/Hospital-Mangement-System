 ...
 */
public class AddMedicineStocks extends javax.swing.JFrame {

    /**
     * Creates new form AddMedicineStocks
     */
    public AddMedicineStocks() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            st.executeUpdate("insert into medicinestock values ('"+medicineID+"','"+medicineName+"','"+date+"','"+quantity+"','"+expiredate+"')");
            JOptionPane.showMessageDialog(null,"Succesfully Updated");
            setVisible(false);
            new addMedicineStocks().setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddMedicineStocks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private static class addMedicineStocks {
